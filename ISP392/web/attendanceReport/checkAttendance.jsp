                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="checkAttendance" method="post">
                                        ...
                                        <input name="studentId" value="${attendance.studentId.id}" type="hidden"> <!-- Chuyển sang hidden để không hiển thị -->
                                        <input name="attendanceId" value="${attendance.id}" type="text" hidden=""> 
