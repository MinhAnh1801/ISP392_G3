...
<html>
    ...
    <body>
        ...
        <div class="container1 mt-20">
            <h2 class="text-3xl">Update Subject</h2>
            <form action="subject" method="post">
                <label for="id">ID:</label>
                <input type="text" id="id" name="id" value="${s.getId()}" readonly><br>
                <div class="form-group">
                    <label for="selectedMajor">Select Major:</label>
                    <select class="p-3 mb-3  border-solid border-[1px] rounded-[5px]"name="selectedMajor" id="selectedMajor">
                ...
                <input type="number" id="tuition" name="tuition" value="${s.getTuition()}"><span> vnđ</span><br>
