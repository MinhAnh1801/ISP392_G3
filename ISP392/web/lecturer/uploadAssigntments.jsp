    ...
    <div class="main-content">
        ...
        <form action="uploadAssignment" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <input type="number" class="form-control" id="subjectID" name="subjectID" placeholder="Enter Subject ID" required>
            </div>

            <div class="form-group mb-3">
                <label for="classID">Class ID</label>
                <input type="number" class="form-control" id="classID" name="classID" placeholder="Enter Class ID" required>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <textarea class="form-control" id="assignmentDescription" name="assignmentDescription" rows="3" placeholder="Enter assignment description" required></textarea>
            </div>
