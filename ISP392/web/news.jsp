...
<html lang="en">
    ...
    <body>
        ...
        <a href="homepage" class="login-item bg-white flex hover:bg-slate-200 duration-200">
        ...
        <table class="absolute top-[250px] left-[300px] table-fixed border-collapse border-2 shadow-md">
            ...
            <tr>
                <th class="border-b-2 w-[45px] h-[50px]">ID</th>
                <th class="border-b-2 w-[236px] h-[50px]">Title</th>
                <th class="border-b-2 w-[204px] h-[50px]">Image</th>
                <th class="border-b-2 w-[306px] h-[50px]">Content</th>
                <th class="border-b-2 w-[306px] h-[50px]">Upload Time</th>
                <th class="border-b-2 w-[116px] h-[50px]">Action</th>
            </tr>
        </table>
        <div class="hidden absolute w-[800px] top-[200px] left-[600px] bg-white shadow-md rounded-lg" id="modal">
            ...
            <div class=" flex h-[74px] w-full m-auto flex ">
                ...
                <input class="w-[700px] h-[60px] outline-none border-b-2 mr-2 mt-2">
            </div>
            ...
            <form class="mt-4 flex items-center space-x-6 ml-[32px] pb-6 border-b-2">
                <label class="block">
            ...
            <div class="flex justify-center">
                <button type="button" class="mt-3 ml-auto text-white bg-green-700 hover:bg-green-800 focus:outline-none font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                    Save
                </button>
            </div>
        </div>
