    ...
    <body>
        <div class="container mt-5">
            ...
            <div class="text-center mb-3">
                <a href="landing.jsp" class="btn btn-light d-flex align-items-center justify-content-center">
            ...
            <div class="text-danger text-center mt-3" id="errormessage">${sessionScope.changepassfail}</div>
            <div class="text-center mt-4">University Academic Portal</div>
        </div>
