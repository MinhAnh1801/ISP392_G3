...
public class ListStudentClass extends HttpServlet {
    ...
    @Override
        ...
        List<StudentClass> students = studentClassDAO.getStudentsInClass(classId); 
        request.setAttribute("students", students);
        request.setAttribute("classId", classId);
        request.getRequestDispatcher("ViewListStudentInClass.jsp").forward(request, response); 
    }
