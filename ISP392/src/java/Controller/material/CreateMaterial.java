...
protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    // Thiết lập Subject cho Material
    MajorDAO mdao = new MajorDAO();
    ...
    // Chỉ lưu tên file vào đối tượng Material
    material.setMaterial_file(new File(filePath).getName());  // Lưu tên file vào đối tượng Material
